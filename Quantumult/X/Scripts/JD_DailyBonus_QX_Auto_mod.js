...
Mod by maxduke shake for 3 times
...
function JingDongShake1(JDBean, JDSteel, JRBean, JRSteel) {
  setTimeout(function() {
    var JDSh = {
      url: 'https://api.m.jd.com/client.action?appid=vip_h5&functionId=vvipclub_shaking',
      method: "GET",
...
function JingDongShake2(JDBean, JDSteel, JRBean, JRSteel, JDShake1) {
  setTimeout(function() {
    var JDSh = {
      url: 'https://api.m.jd.com/client.action?appid=vip_h5&functionId=vvipclub_shaking',
      method: "GET",
...
function JingDongShake3(JDBean, JDSteel, JRBean, JRSteel, JDShake1, JDShake2) {
  setTimeout(function() {
    var JDSh = {
      url: 'https://api.m.jd.com/client.action?appid=vip_h5&functionId=vvipclub_shaking',
      method: "GET",
...
function JRDoubleSign(JDBean, JDSteel, JRBean, JRSteel, JDShake1, JDShake2, JDShake3) {
  setTimeout(function() {
    var JRDSUrl = {
    ...
    $task.fetch(JRDSUrl).then(response => {
      ...
      if (response.body.match(/京豆X/)) {
        ...
        if (cc.resultData.data.businessData.businessData.awardListVo[0].count) {
          ...
          notice(JDBean, JDSteel, JRBean, JRSteel, JDShake1, JDShake2, JDShake3, JRDSign)
        } else {
...
function notice(JDBean, JDSteel, JRBean, JRSteel, JDShake1, JDShake2, JDShake3, JRDSign) {
  //var date = new Date()
  //var month = date.getMonth() + 1
  //var integrate = JDBean + JRBean + JDSteel + JRSteel + JRDSign + JDShake
  //$notify("京东商城&京东金融", month + "月" + date.getDate() + "日 签到状态:", integrate)
  $notify(JRDSign, JDBean, JRBean + JDSteel + JRSteel + JDShake1 + JDShake2 + JDShake3)
}
